...
<head>
    ...
    <link rel="stylesheet" href="../src/views/siteViews/freeslyRestaurant/css/normalize.css">
    <link rel="stylesheet" href="../src/views/siteViews/freeslyRestaurant/css/common.css">
    <link rel="stylesheet" href="../src/views/siteViews/freeslyRestaurant/css/index-style.css">
        ...
        <header class="header">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="../src/views/siteViews/freeslyRestaurant/about.php">About</a></li>
                    <li><a href="../src/views/siteViews/freeslyRestaurant/menus.php">Menus</a></li>
                    <li><a href="../src/views/siteViews/freeslyRestaurant/contact.php">Contact</a></li>
                </ul>
            </nav>
        </header>
